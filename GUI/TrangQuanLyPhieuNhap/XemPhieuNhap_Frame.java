...
import DTO.*;
public class XemPhieuNhap_Frame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public XemPhieuNhap_Frame(TrangQuanLyPhieuNhap_view trangQuanLyPhieuNhap_view) {
...
//		setBackground(new Color(246,225,195));
		...
		XemPhieuNhap_label = new JLabel("XEM PHIẾU NHẬP", SwingConstants.CENTER);
		...
		// controller
		controller_btnThoat_XemPhieuFrame controller_btnThoat_XemPhieuFrame = new controller_btnThoat_XemPhieuFrame(this, trangQuanLyPhieuNhap_view);
		btn_ThoatPN.addMouseListener(controller_btnThoat_XemPhieuFrame);
		ShowPhieu();
		setVisible(true);
	}
	public void ShowPhieu(){
		...
		if(phieuNhap != null){
			...
			this.GanMaNCC_label.setText(phieuNhap.getMaNXS());
			this.GanMaNV_label.setText(phieuNhap.getIDNhanVien());
			this.GanNgay_label.setText(phieuNhap.getDate());
			this.GanTinhTrang_label.setText(phieuNhap.getTinh_trang());
			this.GanTongTien_label.setText(String.valueOf(phieuNhap.getSumMoney()));
			dsChiTietPhieuBUS dsChiTietPhieu = phieuNhap.getDsChitietphieu2();
