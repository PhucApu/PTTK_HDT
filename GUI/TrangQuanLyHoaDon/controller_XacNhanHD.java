...
public class controller_XacNhanHD extends MouseAdapter {
       private TrangQuanLyHoaDon_view trangQuanLyHoaDon_view;

       public controller_XacNhanHD(TrangQuanLyHoaDon_view trangQuanLyHoaDon_view) {
       ...
       public void mouseClicked(MouseEvent e) {
              new Thread( new Runnable() {
                     ...
                     public void run() {
                            Sys.Sound_Click();
                            getTrangQuanLyHoaDon_view().XacNhanHoaDon_Frame();
                     }
              }).start();
       }
}
