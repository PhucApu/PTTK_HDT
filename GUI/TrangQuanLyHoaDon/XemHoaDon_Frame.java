...
public class XemHoaDon_Frame extends JFrame {
	 ...
	 * Create the frame.
	 */
	public XemHoaDon_Frame(TrangQuanLyHoaDon_view trangQuanLyHoaDon_view) {
		...
		XemHoaDon_label = new JLabel("XEM HÓA ĐƠN", SwingConstants.CENTER);
		...
		// controller
		controller_btnThoat_XemHDFrame controller_btnThoat_XemHDFrame = new controller_btnThoat_XemHDFrame(trangQuanLyHoaDon_view, this);
		btn_ThoatPN.addMouseListener(controller_btnThoat_XemHDFrame);
		setVisible(true);
	}
	...
	public void ShowPhieu() {
		...
		if (hoaDon != null) {
			...
			this.GanTinhTrang_label.setText(hoaDon.getTinhTrang());
			...
			// JOptionPane.showConfirmDialog(null, "HÃY CHỌN MỘT PHIẾU TRONG BẢNG", "Thông báo",
			// 			JOptionPane.ERROR_MESSAGE);
			Sys.Warning_dialog("HÃY CHỌN MỘT PHIẾU TRONG BẢNG");
			Sys.Sound_Error();
		}
	}
