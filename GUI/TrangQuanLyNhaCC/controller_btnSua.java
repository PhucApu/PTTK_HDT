...
public class controller_btnSua extends MouseAdapter {
	...
	public controller_btnSua(TrangQuanLyNhaCC_view trangQuanLyNhaCC_view) {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if(this.trangQuanLyNhaCC_view.getCheck_open_Jrame() == 0) {
			new Thread( new Runnable() {
				...
				@Override
				public void run() {
					getTrangQuanLyNhaCC_view().setCheck_open_Jrame(2);
					getTrangQuanLyNhaCC_view().SuaNhaCC_Frame();
				}
			}).start();
		}
