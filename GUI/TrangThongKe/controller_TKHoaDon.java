...
public class controller_TKHoaDon extends MouseAdapter {
       private TrangThongKe_view trangThongKe_view;

       public controller_TKHoaDon(TrangThongKe_view trangThongKe_view) {
              ...
              new Thread( new Runnable() {
                     ...
                     public void run() {
                            ...
                            if(getTrangThongKe_view().getCheck_open_Jrame() == 0){
                                   ...
                                   getTrangThongKe_view().btn_ThongKeHoaDon();
                            }
                            else {
