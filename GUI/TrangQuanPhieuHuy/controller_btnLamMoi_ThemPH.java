...
public class controller_btnLamMoi_ThemPH extends MouseAdapter {
       private ThemPhieuHuy_Frame themPhieuHuy_Frame;

       public controller_btnLamMoi_ThemPH(ThemPhieuHuy_Frame themPhieuHuy_Frame) {
       ...
       public void mouseClicked(MouseEvent e) {
              new Thread( new Runnable() {
                     ...
                     public void run() {
                            Sys.Sound_Click();
                            getThemPhieuHuy_Frame().btnLamMoiHD();
                     }
              }).start();
       }
}
